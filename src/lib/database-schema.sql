-- This script fixes the user signup process by adding the necessary function and trigger.
-- It is designed to be run on an existing database where the tables are already created.

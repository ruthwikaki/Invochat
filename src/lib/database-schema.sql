...
-- Function to update sale_items with product_id and then make it NOT NULL
CREATE OR REPLACE FUNCTION public.migrate_sale_items_to_product_id()
RETURNS void AS $$
BEGIN
    -- This function is now part of the main migration script and can be run manually.
    -- The core logic is preserved in the migration steps below.
    RAISE NOTICE 'This function is deprecated. Please follow the manual migration steps.';
END;
$$ LANGUAGE plpgsql;

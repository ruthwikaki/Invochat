    ...
    <div className="flex min-h-dvh flex-col items-center justify-center bg-background p-4">
        ...
        <CardContent className="text-center space-y-4">
            ...
            <div className="text-left p-4 bg-muted rounded-md border text-sm">
                <p>1. In your project, find the correct script to run:</p>
                <ul className="list-disc pl-5 mt-2 space-y-1">
                    <li><span className="font-semibold">For a brand new project:</span> Use <code className="font-mono bg-muted-foreground/20 px-1 py-0.5 rounded-sm">src/lib/database-schema.sql</code></li>
                    <li><span className="font-semibold">If you have an existing database:</span> Run any migration scripts you haven't applied yet, in order (e.g., <code className="font-mono bg-muted-foreground/20 px-1 py-0.5 rounded-sm">src/lib/migration-2024-07-29.sql</code>, then <code className="font-mono bg-muted-foreground/20 px-1 py-0.5 rounded-sm">src/lib/migration-2024-08-05.sql</code>).</li>
                </ul>

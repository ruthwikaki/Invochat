...
// This tool now directly uses the database service function, which already filters for items
// not sold in 90 days, removing redundant logic from the tool itself.

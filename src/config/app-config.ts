...
const EnvSchema = z.object({
  ...
  ENCRYPTION_KEY: z.string().length(64, { message: "Must be a 64-character (32-byte) hex string." }),
  ENCRYPTION_IV: z.string().length(32, { message: "Must be a 32-character (16-byte) hex string." }),
});

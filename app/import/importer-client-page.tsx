...
const importOptions = {
    'product-costs': {
        label: 'Product Costs & Reorder Rules',
        description: 'Import or update product costs, suppliers, and reorder points by SKU.',
    },
    'suppliers': {
        label: 'Suppliers / Vendors',
        description: 'Import a list of your suppliers and their contact information.',
    },
    'historical-sales': {
        label: 'Historical Sales',
        description: "Import past sales data to train the AI on demand forecasting.",
    },
};
...
export function ImporterClientPage() {
    const [dataType, setDataType] = useState<DataType>('product-costs');
    ...
    useEffect(() => {
        const token = getCookie(CSRF_FORM_NAME);
